...
> Был создан shell скрипт, выполняющий команду дампа с указанием директории, а также команду удаления файлов, первышающих указанную в переменной времени. (ротация)  
